  ...
  return (
    <section className="border-b border-line bg-surface">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        ...
        <dl className="mt-12 grid grid-cols-1 border-t-2 border-ink sm:grid-cols-2 lg:grid-cols-4">
          {COSTS.map((cost) => (
            <div key={cost.label} className="border-b border-line py-6 sm:pr-6 lg:border-b-0">
